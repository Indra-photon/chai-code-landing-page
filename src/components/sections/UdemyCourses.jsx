            ...
            >
              ...
              <div className="flex flex-col h-full p-2">
                ...
                <div className="flex items-center mb-2">
                  <div className="flex">
                    {[...Array(5)].map((_, i) => (
                      <svg key={i} className={`w-5 h-5 ${i < Math.floor(courses[activeIndex].rating) ? 'text-amber' : 'text-gray-300'}`} fill="currentColor" viewBox="0 0 20 20">
                ...
                <div className="flex items-center mb-4">
                  <span className="text-3xl font-bold text-amber">₹{courses[activeIndex].price}</span>
                  <span className="text-text-secondary ml-2 line-through">₹{courses[activeIndex].originalPrice}</span>
                  <span className="ml-2 bg-amber/20 text-amber text-xs font-bold px-2 py-1 rounded">{courses[activeIndex].discount}% off</span>
                </div>
